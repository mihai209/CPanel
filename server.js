...
registerWebSocketRuntime({
    ...
    Connector,
    Settings,
    getServerPolicyEngineConfig: legacyHelpers.getServerPolicyEngineConfig,
    isServerPolicyEditLocked: legacyHelpers.isServerPolicyEditLocked,
    isServerPolicyPathReadOnly: legacyHelpers.isServerPolicyPathReadOnly,
    buildServerEnvironment: legacyHelpers.buildServerEnvironment,
    buildStartupCommand: legacyHelpers.buildStartupCommand,
    resolveImagePorts: legacyHelpers.resolveImagePorts,
    buildDeploymentPorts: legacyHelpers.buildDeploymentPorts,
