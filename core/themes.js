...
const THEME_PREVIEWS = Object.freeze({
    ...
    hacker: {
        ...
        background: "linear-gradient(rgba(3, 8, 7, 0.82), rgba(3, 8, 7, 0.82)), url('https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1280&q=80'), linear-gradient(180deg, #030807 0%, #07110e 38%, #081511 100%)",
    ...
    minecraft: {
        ...
        background: "linear-gradient(rgba(11, 24, 11, 0.82), rgba(11, 24, 11, 0.82)), url('https://images.unsplash.com/photo-1623939012331-98979500bcc1?auto=format&fit=crop&w=1280&q=80'), linear-gradient(145deg, #183320 0%, #355f32 100%)",
    ...
    'retro-synth': {
        ...
        background: "linear-gradient(rgba(26, 15, 47, 0.82), rgba(26, 15, 47, 0.82)), url('https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&w=1280&q=60'), linear-gradient(145deg, #180d26 0%, #36124a 100%)",
    ...
    'zombie-apocalipse': {
        ...
        background: "linear-gradient(rgba(24, 27, 22, 0.85), rgba(24, 27, 22, 0.85)), url('https://images.unsplash.com/photo-1509248961158-e54f6934749c?auto=format&fit=crop&w=1280&q=80'), linear-gradient(180deg, #181b16 0%, #262d21 38%, #0f120e 100%)",
