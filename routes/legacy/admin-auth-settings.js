...
app.post('/admin/settings', requireAuth, requireAdmin, [
    ...
    const nextSettings = {
        ...
        abuseScoreAlertThreshold: toNumberString(req.body.abuseScoreAlertThreshold, 80, 1, 1000),
        featureServiceHealthChecksEnabled: toBooleanString(req.body.featureServiceHealthChecksEnabled),
        serviceHealthCheckIntervalSeconds: toNumberString(req.body.serviceHealthCheckIntervalSeconds, 300, 30, 86400),
...
app.post('/admin/let-user-create', requireAuth, requireAdmin, async (req, res) => {
    const nextSettings = {
        ...
        featureBillingInvoicesEnabled: toBooleanString(req.body.featureBillingInvoicesEnabled),
        featureBillingInvoiceWebhookEnabled: toBooleanString(req.body.featureBillingInvoiceWebhookEnabled),
