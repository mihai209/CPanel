(() => {
  ...
  function ServerScalingPage({ pageData = {} }) {
    ...
    const [newRule, setNewRule] = (0, import_react7.useState)({
      name: "",
      timezone: config.timezone || "UTC",
      hour: 0,
      minute: 0,
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ReactAppShell, { pageData, subtitle: "Scheduled Scaling", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "max-w-7xl mx-auto space-y-6", children: [
      status.message && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: `p-4 rounded-xl border flex items-center gap-3 ${status.type === "error" ? "bg-red-500/10 border-red-500/20 text-red-400" : status.type === "success" ? "bg-green-500/10 border-green-500/20 text-green-400" : "bg-blue-500/10 border-blue-500/20 text-blue-400"}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: `bi ${status.type === "error" ? "bi-exclamation-triangle-fill" : status.type === "success" ? "bi-check-circle-fill" : "bi-info-circle-fill"}` }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-sm font-medium", children: status.message })
      ] }),
      inventoryEnabled && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-neutral-800 p-6 flex flex-wrap gap-6 items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex-1 min-w-[200px]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h2", { className: "text-lg font-bold text-white flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-wallet2 text-primary-400" }),
            "Inventory Budget"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-neutral-500 mt-1", children: "Scaling consumes inventory on increase and returns it on decrease." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-wrap gap-4", children: [
        ...
        ].map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-4 py-2 rounded-xl bg-neutral-950/50 border border-neutral-800 text-center min-w-[100px]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-[10px] font-black text-neutral-500 uppercase tracking-widest", children: item.label }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-sm font-bold text-neutral-200", children: [
            item.val,
            " ",
            item.unit
          ] })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "grid lg:grid-cols-12 gap-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "lg:col-span-5 space-y-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900/50 rounded-2xl border border-neutral-800 p-6 shadow-sm", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: "text-sm font-black text-neutral-500 uppercase tracking-widest mb-6 px-1", children: "Engine Configuration" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("form", { onSubmit: handleSaveSettings, className: "space-y-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[11px] font-bold text-neutral-400 px-1", children: "System Timezone" }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-col justify-center gap-1 mt-4", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between p-2.5 rounded-xl bg-neutral-950 border border-neutral-800", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[11px] font-bold text-neutral-300", children: "Enabled" }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "button",
                    {
                      type: "button",
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `absolute top-0.5 left-0.5 w-3 h-3 bg-white rounded-full transition-transform ${settings.enabled ? "translate-x-4" : ""}` })
                    }
                  )
                ] }) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-[10px] text-neutral-500 leading-relaxed italic", children: "Rules run each minute and apply when day/hour/minute match in the rule timezone." }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "button",
                {
                  type: "submit",
          ...
          canManageScaling && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900/80 backdrop-blur-md rounded-2xl border border-neutral-800 p-6 shadow-xl", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: "text-sm font-black text-neutral-500 uppercase tracking-widest mb-6 px-1", children: "Create New Rule" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("form", { onSubmit: handleAddRule, className: "space-y-5", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[11px] font-bold text-neutral-400 px-1", children: "Rule Name" }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "input",
                    {
                      required: true,
                ...
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[11px] font-bold text-neutral-400 px-1", children: "Hour (0-23)" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                      "input",
                      {
                        type: "number",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[11px] font-bold text-neutral-400 px-1", children: "Minute (0-59)" }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                      "input",
                      {
                        type: "number",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid grid-cols-2 gap-3", children: [
                { label: "RAM (MB)", key: "memory" },
                { label: "CPU (%)", key: "cpu" },
                { label: "Disk (MB)", key: "disk" },
                { label: "Swap (MB)", key: "swapLimit" }
              ].map((field) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[10px] font-bold text-neutral-500 px-1", children: field.label }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[11px] font-bold text-neutral-400 px-1 block", children: "Active Days" }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-wrap gap-1.5", children: DAY_LABELS.map((day, idx) => {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-4 py-2 border-t border-neutral-800 pt-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-2 cursor-pointer", onClick: () => setNewRule({ ...newRule, enabled: !newRule.enabled }), children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `w-4 h-4 rounded border flex items-center justify-center transition-colors ${newRule.enabled ? "bg-primary-500 border-primary-500" : "bg-neutral-950 border-neutral-700"}`, children: newRule.enabled && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-check-lg text-white text-[10px]" }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[11px] font-bold text-neutral-400", children: "Rule Enabled" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-2 cursor-pointer", onClick: () => setNewRule({ ...newRule, oomKillDisable: !newRule.oomKillDisable }), children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `w-4 h-4 rounded border flex items-center justify-center transition-colors ${newRule.oomKillDisable ? "bg-orange-500 border-orange-500" : "bg-neutral-950 border-neutral-700"}`, children: newRule.oomKillDisable && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-check-lg text-white text-[10px]" }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[11px] font-bold text-neutral-400", children: "Disable OOM Kill" })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "lg:col-span-7 space-y-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-neutral-800 p-6 shadow-sm overflow-hidden", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between mb-8 px-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h2", { className: "text-lg font-bold text-white flex items-center gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-list-task text-primary-400" }),
                  "Active Rules"
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xs text-neutral-500 mt-1 uppercase tracking-wider font-semibold", children: "Automated resource management" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "px-3 py-1.5 rounded-full bg-neutral-800 text-[10px] font-black uppercase tracking-widest text-neutral-400", children: [
                rules.length,
                " Rules"
              ] })
            ] }),
            rules.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-center py-20 bg-neutral-950/30 rounded-2xl border border-dashed border-neutral-800", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-calendar-x text-5xl text-neutral-700 mb-4 block" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-neutral-500 text-sm font-medium", children: "No scaling rules configured." }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-[10px] text-neutral-700 uppercase tracking-widest font-black mt-2", children: "Start by adding your first peak-time rule" })
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-4", children: rules.map((rule) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "group relative bg-neutral-900/30 rounded-2xl border border-neutral-800 p-5 hover:bg-neutral-800/20 transition-all", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-wrap items-start justify-between gap-4 mb-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: "font-bold text-neutral-200", children: rule.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: `px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest ${rule.enabled === false ? "bg-neutral-800 text-neutral-500" : "bg-green-500/10 text-green-500"}`, children: rule.enabled === false ? "Disabled" : "Enabled" }),
                    rule.oomKillDisable && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "px-2 py-0.5 rounded bg-orange-500/10 text-orange-500 text-[9px] font-black uppercase tracking-widest", children: "No-OOM" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-1.5 text-[11px] text-neutral-500 font-bold", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-calendar2-week" }),
                      formatDays(rule.daysOfWeek)
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-1.5 text-[11px] text-blue-400 font-bold", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-clock" }),
                      String(rule.hour || 0).padStart(2, "0"),
                      ":",
                      String(rule.minute || 0).padStart(2, "0"),
                      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[9px] text-neutral-600 ml-1 font-medium", children: rule.timezone })
                    ] })
                  ] })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "flex items-center gap-2", children: canManageScaling && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "button",
                  {
                    ...
                    title: "Delete Rule",
                    children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-trash-fill" })
                  }
                ) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-neutral-950/40 border border-neutral-800/50", children: [
              ...
              ].map((limit) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest mb-0.5", children: limit.label }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-xs font-bold text-neutral-300", children: limit.val })
              ] }, limit.label)) }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "mt-3 flex items-center justify-between", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-[10px] text-neutral-500 font-medium italic", children: [
                  "Last Applied: ",
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-400 font-bold not-italic", children: rule.lastAppliedSlot || "-" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-[10px] text-neutral-700 font-black uppercase tracking-tighter", children: [
                  "ID: ",
                  rule.id
                ] })
              ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-primary-500/5 rounded-2xl border border-primary-500/10 p-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h3", { className: "text-sm font-bold text-primary-400 mb-4 flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-lightbulb-fill" }),
              "Scaling Best Practices"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("ul", { className: "space-y-3", children: [
            ...
            ].map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "w-1 h-1 rounded-full bg-primary-500/50 mt-2 shrink-0" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-xs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-200 font-bold block", children: item.title }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-500 leading-relaxed", children: item.desc })
              ] })
            ] }, i)) })
          ] })
        ] })
