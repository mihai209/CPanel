(() => {
  ...
  function ConnectorGridCard({ item }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "bg-neutral-800/50 border border-neutral-700/50 rounded-2xl p-6 hover:border-neutral-600 transition-all group shadow-xl", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex justify-between items-start mb-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { className: "text-lg font-bold text-white group-hover:text-primary-400 transition-colors uppercase tracking-tight", children: connector.name }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-xs text-neutral-500 font-mono mt-1", children: [
            connector.fqdn,
            " ",
            connector.location?.shortName && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-neutral-700 mx-1", children: "|" }),
            " ",
            connector.location?.shortName
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: `px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 ${isOnline ? "bg-green-500/10 text-green-500 border border-green-500/20" : "bg-neutral-700 text-neutral-400 border border-neutral-600"}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: `w-1.5 h-1.5 rounded-full ${isOnline ? "bg-green-500 animate-pulse" : "bg-neutral-500"}` }),
          isOnline ? "Online" : "Offline"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "grid grid-cols-2 gap-6 mb-6", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "space-y-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex justify-between items-end", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-[10px] font-black text-neutral-500 uppercase tracking-widest", children: "RAM Capacity" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: `text-xs font-bold ${ramTheme.text}`, children: [
              fmt(metrics.memoryFreeGb),
              " GB Free"
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "h-2 bg-neutral-900 rounded-full overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            "div",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex justify-between text-[10px] font-bold", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "text-neutral-500", children: [
              fmt(metrics.memoryUsedGb),
              " used"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "text-neutral-400", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "space-y-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex justify-between items-end", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-[10px] font-black text-neutral-500 uppercase tracking-widest", children: "Disk Capacity" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: `text-xs font-bold ${diskTheme.text}`, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "grid grid-cols-3 gap-4 py-4 border-t border-neutral-700/30", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest mb-1", children: "Allocations" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-sm font-bold text-neutral-200", children: [
            metrics.freeAllocations,
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "text-neutral-600 text-[10px]", children: [
              "/ ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest mb-1", children: "CPU Host" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-sm font-bold text-neutral-200", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest mb-1", children: "CPU Allocs" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-sm font-bold text-neutral-200", children: [
            fmt(metrics.cpuAllocatedCores, 2),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-[10px] text-neutral-600 ms-1", children: "C" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mt-4 pt-4 border-t border-neutral-700/30 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "text-[10px] text-neutral-500 font-bold uppercase tracking-wider", children: [
          "Last Seen: ",
  ...
  function ConnectorsCheckPage({ pageData = data }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ReactAppShell, { pageData, subtitle: "Infrastructure Health", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      PageContentBlock,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-2xl p-6 mb-8 shadow-2xl", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("form", { method: "GET", action: "/connectors-check", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "lg:col-span-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-2", children: "Search Network" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-2", children: "Node Status" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
                  "select",
                  {
                    ...
                    className: "w-full bg-neutral-900 border border-neutral-700 rounded-xl px-4 py-2.5 text-sm text-white focus:border-primary-500 transition-colors outline-none",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "all", children: "All States" }),
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "online", children: "Online Only" }),
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "offline", children: "Offline Only" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-2", children: "Min RAM (GB)" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-2", children: "Min Alloc Free" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                  "input",
                  {
                    type: "number",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { type: "submit", className: "flex-1 bg-primary-600 hover:bg-primary-500 text-white font-black text-[10px] uppercase tracking-widest py-3 rounded-xl transition-all shadow-lg shadow-primary-900/20 active:scale-95", children: "Apply" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("a", { href: "/connectors-check", className: "p-3 bg-neutral-700 hover:bg-neutral-600 text-white rounded-xl transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-arrow-counterclockwise" }) })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mt-4 flex items-center justify-between text-[10px] font-bold uppercase tracking-wider", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-neutral-500", children: [
                "Filtered Analysis: ",
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-neutral-200", children: items.length }),
                " nodes found"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-neutral-500", children: [
                "Total Cluster Size: ",
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-neutral-200", children: pageData.totalCards })
              ] })
            ] })
          ] }),
          items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "py-20 flex flex-col items-center justify-center bg-neutral-800/20 border border-neutral-800 border-dashed rounded-3xl", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-activity text-5xl text-neutral-700 mb-4" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { className: "text-lg font-bold text-neutral-400", children: "No connectors match your parameters." }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-sm text-neutral-600 mt-1", children: "Try relaxing your RAM or Allocation requirements." })
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: items.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "animate-in fade-in slide-in-from-bottom-4 duration-500", style: { animationDelay: `${idx * 40}ms` }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ConnectorGridCard, { item }) }, item.connector.id || idx)) })
        ]
      }
    ) });
  }
  ...
  if (root) {
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BrowserRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ConnectorsCheckPage, { pageData: data }) })
    );
