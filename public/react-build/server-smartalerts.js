(() => {
  ...
  function ServerSmartAlertsPage({ pageData = {} }) {
    ...
    const [showTutorial, setShowTutorial] = (0, import_react7.useState)(false);
    const [tutorialTab, setTutorialTab] = (0, import_react7.useState)("discord");
    ...
    const Section = ({ title, icon, children }) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900/50 backdrop-blur-sm rounded-2xl border border-neutral-800 overflow-hidden shadow-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-6 py-4 bg-neutral-900/30 border-b border-neutral-800 flex items-center gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: `bi ${icon} text-primary-400` }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: "text-sm font-black text-neutral-500 uppercase tracking-widest", children: title })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "p-6", children })
    ] });
    const Toggle = ({ label, checked, onChange, helper }) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("label", { className: "flex items-center justify-between p-4 rounded-xl bg-neutral-950/50 border border-neutral-800 hover:border-neutral-700 transition-all cursor-pointer group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-col gap-0.5", children: [
        ...
        helper && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[10px] text-neutral-500 font-medium uppercase tracking-tighter", children: helper })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "relative", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("input", { type: "checkbox", checked, onChange: (e) => onChange(e.target.checked), className: "sr-only" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `w-10 h-5 rounded-full transition-colors ${checked ? "bg-primary-500" : "bg-neutral-800"}`, children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `absolute top-1 left-1 w-3 h-3 bg-white rounded-full transition-transform ${checked ? "translate-x-5" : ""}` }) })
      ] })
    ] });
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(ReactAppShell, { pageData, subtitle: "Smart Alerts", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("form", { onSubmit: handleSubmit, className: "max-w-7xl mx-auto space-y-6 pb-24", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "grid lg:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Section, { title: "General State", icon: "bi-broadcast-pin", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              Toggle,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Section, { title: "Discord Integration", icon: "bi-discord", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "block text-[10px] font-black text-neutral-600 uppercase tracking-widest mb-2 px-1", children: "Webhook URL" }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Section, { title: "Telegram Integration", icon: "bi-telegram", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "grid md:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "block text-[10px] font-black text-neutral-600 uppercase tracking-widest px-1", children: "Bot Token" }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "block text-[10px] font-black text-neutral-600 uppercase tracking-widest px-1", children: "Chat ID" }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "input",
                  {
                    type: "text",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Section, { title: "Event Subscriptions", icon: "bi-lightning-charge-fill", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid md:grid-cols-3 gap-3", children: Object.keys(formData.events).map((key) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { onClick: () => handleToggle(`events.${key}`, !formData.events[key]), className: `p-3 rounded-xl border cursor-pointer transition-all flex flex-col items-center justify-center gap-2 text-center group ${formData.events[key] ? "bg-primary-500/10 border-primary-500/30" : "bg-neutral-950/30 border-neutral-800 hover:border-neutral-700"}`, children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: `bi bi-${formData.events[key] ? "check-circle-fill text-primary-400" : "circle text-neutral-700"}` }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: `text-[9px] font-black uppercase tracking-widest ${formData.events[key] ? "text-primary-400" : "text-neutral-500"}`, children: key.replace(/([A-Z])/g, " $1") })
            ] }, key)) }) }),
            " Section>"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Section, { title: "Anomaly Detection", icon: "bi-activity", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                Toggle,
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid grid-cols-3 gap-3 mt-6", children: [
              ...
              ].map((item) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest px-1", children: item.label }),
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                  "input",
                  {
                    type: "number",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Section, { title: "Log Rotation & Cleanup", icon: "bi-trash-fill", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                Toggle,
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "mt-6 space-y-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("label", { className: "text-[9px] font-black text-neutral-600 uppercase tracking-widest px-1", children: "Cleanup Path" }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid grid-cols-3 gap-3", children: [
      ...
      showTutorial && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "fixed inset-0 bg-black/80 backdrop-blur-sm z-[1000] flex items-center justify-center p-6 animate-in fade-in", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900 border border-neutral-800 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl scale-in-95 animate-in", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-8 py-6 border-b border-neutral-800 flex items-center justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h3", { className: "text-xl font-bold text-white flex items-center gap-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-patch-question-fill text-blue-400" }),
            "Smart Alerts Guide"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("button", { onClick: () => setShowTutorial(false), className: "w-8 h-8 rounded-full bg-neutral-800 hover:bg-neutral-700 text-neutral-400 flex items-center justify-center transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-x-lg" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "p-8", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex gap-2 mb-8 bg-neutral-950 p-1 rounded-2xl border border-neutral-800", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              "button",
              {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "space-y-6", children: tutorialTab === "discord" ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h4", { className: "text-sm font-bold text-neutral-200", children: "Webhook Setup" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("ol", { className: "space-y-3 text-xs text-neutral-400 list-decimal ml-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("li", { children: "Open Server Settings \u2192 Integrations \u2192 Webhooks" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("li", { children: [
                "Create ",
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-primary-400 font-bold", children: "New Webhook" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("li", { children: "Copy Webhook URL and paste it in the field behind" })
            ] })
          ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_jsx_runtime7.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "space-y-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h4", { className: "text-sm font-bold text-neutral-200", children: "Bot Creation" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("ol", { className: "space-y-3 text-xs text-neutral-400 list-decimal ml-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("li", { children: [
                "Search for ",
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-primary-400 font-bold", children: "@BotFather" }),
                " on Telegram"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("li", { children: [
                "Run ",
                /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("code", { className: "text-blue-300", children: "/newbot" }),
                " and get your token"
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("li", { children: "Add the bot to your group and target the chat ID" })
            ] })
          ] }) }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "px-8 py-6 bg-neutral-950/50 border-t border-neutral-800 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-[10px] text-neutral-600 font-bold uppercase tracking-widest", children: "Always test a simple start/stop after saving." }) })
      ] }) })
    ] });
  }
})();
