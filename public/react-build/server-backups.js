(() => {
  ...
  function ServerBackupsPage({ pageData = data }) {
    ...
    const [isClearing, setIsClearing] = import_react6.default.useState(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ReactAppShell, { pageData, subtitle: "Backups", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      PageContentBlock,
      {
        title: "Backups",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-end gap-3 mb-6", children: [
            permissions.canManageBackups && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: `bi ${isClearing ? "bi-hourglass-split" : "bi-trash3"}` }),
                  isClearing ? "Clearing..." : "Clear History"
                ]
              }
            ),
            permissions.canManageBackups ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("form", { method: "POST", action: actions.run, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("button", { type: "submit", className: "bg-primary-600 hover:bg-primary-500 text-white font-semibold py-2 px-6 rounded transition-colors text-sm shadow-sm flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-hdd-rack" }),
              " Create Backup"
            ] }) }) : null
          ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 items-start mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg p-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-3 mb-6", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-google text-2xl text-primary-400" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "text-lg font-bold text-neutral-100", children: "Drive Integration" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-col gap-4 mb-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-between items-center border-b border-neutral-700/50 pb-3", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-sm font-semibold text-neutral-400", children: "Server" }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "text-neutral-200", children: server.name || "Server" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-between items-center border-b border-neutral-700/50 pb-3", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-sm font-semibold text-neutral-400", children: "Drive Ready" }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: driveState.ready ? "text-green-400" : "text-neutral-400", children: driveState.ready ? "Ready" : "Needs setup" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-between items-center pb-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-sm font-semibold text-neutral-400", children: "Last Run" }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "text-neutral-200 font-mono text-sm", children: formatWhen(policy.lastRunAt) })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "text-sm text-neutral-400 italic mb-4", children: driveState.statusText || "Google Drive state is unavailable." }),
              driveState.canConnect ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("a", { href: actions.connectGoogle || driveState.connectUrl, className: "inline-block bg-neutral-700 hover:bg-neutral-600 text-white font-semibold py-2 px-6 rounded transition-colors text-sm text-center w-full shadow-sm", children: "Connect Google Drive" }) : null
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg p-6 flex flex-col h-full", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-3 mb-6", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-calendar-event text-2xl text-primary-400" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "text-lg font-bold text-neutral-100", children: "Automated Policy" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("form", { method: "POST", action: actions.savePolicy, className: "flex flex-col gap-5 flex-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "flex items-start gap-3 cursor-pointer group mb-2", children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "block text-sm font-bold text-neutral-200 group-hover:text-white transition-colors", children: "Enable scheduled backups" }),
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "block text-xs text-neutral-500 mt-1", children: "Automatically generates periodic backups in the background." })
                  ] })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "mb-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: labelClass, children: "Interval in minutes" }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "relative", children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none text-neutral-500 text-xs font-bold", children: "MIN" })
                  ] })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "mt-auto flex justify-end flex-wrap pt-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "submit", className: "w-full bg-primary-600 hover:bg-primary-500 text-white font-semibold py-2 px-6 rounded transition-colors text-sm shadow-sm disabled:opacity-50", disabled: !permissions.canManageBackupPolicy, children: "Save Policy" }) })
              ] })
            ] })
          ] }),
          pageData.activeJob ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-primary-900/20 border-2 border-primary-600/50 rounded-lg p-6 mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h2", { className: "text-lg font-bold text-white mb-4 flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-arrow-repeat animate-spin text-primary-400" }),
              " Active Backup Job"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900/50 p-3 rounded", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "block text-xs font-bold text-neutral-500 uppercase", children: "Status" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "block text-sm text-primary-300 mt-1", children: pageData.activeJob.status })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900/50 p-3 rounded", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "block text-xs font-bold text-neutral-500 uppercase", children: "Type" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "block text-sm text-neutral-200 mt-1", children: pageData.activeJob.type })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900/50 p-3 rounded", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "block text-xs font-bold text-neutral-500 uppercase", children: "Updated" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "block text-sm text-neutral-200 mt-1 font-mono", children: formatWhen(pageData.activeJob.updatedAt) })
              ] })
            ] })
          ] }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg overflow-hidden", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "px-6 py-4 border-b border-neutral-700 bg-neutral-800/80", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "text-lg font-bold text-neutral-100", children: "Backup History" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-col", children: [
              !backups.length ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "p-8 text-center text-sm text-neutral-500", children: "No backups were recorded yet." }) : null,
              backups.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: `p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors hover:bg-neutral-700/20 ${index !== backups.length - 1 ? "border-b border-neutral-700/50" : ""}`, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-col gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-archive text-xl text-neutral-400" }),
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { className: "text-neutral-100 font-mono text-sm tracking-wide", children: formatWhen(entry.createdAt) }),
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: `px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide inline-block ${statusColorClass(entry.status)}`, children: entry.status || "unknown" })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "text-sm text-neutral-400 flex items-center gap-2 pl-8", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "capitalize", children: entry.trigger || "manual" }),
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-neutral-600", children: "\u2022" }),
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "font-mono", children: formatBytes(entry.sizeBytes) })
                  ] }),
                  entry.error ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "text-xs text-red-400 font-mono mt-1 pl-8 bg-red-900/10 p-2 rounded", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-exclamation-triangle mr-1" }),
                    " ",
                    entry.error
                  ] }) : null
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-wrap items-center gap-2 sm:justify-end shrink-0 pt-3 sm:pt-0 border-t border-neutral-700 sm:border-0 pl-8 sm:pl-0", children: [
                  entry.webViewLink ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: entry.webViewLink, className: "bg-transparent hover:bg-neutral-700 text-neutral-300 hover:text-white border border-neutral-600 hover:border-neutral-500 text-xs font-semibold py-1.5 px-4 rounded transition-colors flex items-center gap-2", target: "_blank", rel: "noreferrer", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-link-45deg" }),
                    " Open File"
                  ] }) : null,
                  entry.folderLink ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("a", { href: entry.folderLink, className: "bg-neutral-700 hover:bg-neutral-600 text-white border border-neutral-600 hover:border-neutral-500 text-xs font-semibold py-1.5 px-4 rounded transition-colors flex items-center gap-2", target: "_blank", rel: "noreferrer", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-folder2-open" }),
                    " Folder"
                  ] }) : null
                ] })
              ] }, entry.id))
  ...
  if (root) {
    root.render(/* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ServerBackupsPage, { pageData: data }));
