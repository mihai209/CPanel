(() => {
  ...
  function ServerMinecraftInstallerPage({ pageData = data }) {
    ...
    const [selectedPlatform, setSelectedPlatform] = import_react8.default.useState(null);
    const [selectedVersion, setSelectedVersion] = import_react8.default.useState("");
    const [selectedBuild, setSelectedBuild] = import_react8.default.useState("");
    const [installing, setInstalling] = import_react8.default.useState(false);
    const [error, setError] = import_react8.default.useState(pageData.error || null);
    const [success, setSuccess] = import_react8.default.useState(pageData.success || null);
    const availableVersions = import_react8.default.useMemo(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ReactAppShell, { pageData, subtitle: "Version Installer", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      PageContentBlock,
      {
        ...
        children: [
          error && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-8 bg-rose-600/10 border border-rose-600/20 text-rose-500 p-6 rounded-3xl flex items-center gap-4 animate-in slide-in-from-top-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-exclamation-octagon text-2xl" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "font-bold uppercase tracking-widest text-sm", children: error })
          ] }),
          success && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-8 bg-emerald-600/10 border border-emerald-600/20 text-emerald-500 p-6 rounded-3xl flex items-center gap-4 animate-in slide-in-from-top-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-check-circle text-2xl" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "font-bold uppercase tracking-widest text-sm", children: success })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "mb-10", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("h3", { className: "text-sm font-black text-white uppercase tracking-[0.2em] mb-6 flex items-center gap-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "w-6 h-6 rounded-lg bg-neutral-800 flex items-center justify-center text-[10px]", children: "1" }),
              "Select Platform"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: PLATFORMS.map((platform) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: `shrink-0 w-12 h-12 rounded-xl flex items-center justify-center text-xl shadow-lg ${selectedPlatform === platform.id ? "bg-primary-600 text-white" : platform.color}`, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: `bi ${platform.icon}` }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h4", { className: "font-black text-white uppercase tracking-widest text-xs mb-1 group-hover:text-primary-400 transition-colors", children: platform.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-[10px] text-neutral-500 font-bold uppercase tracking-widest leading-relaxed", children: platform.description })
                  ] })
                ]
              },
              platform.id
          ...
          selectedPlatform && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "animate-in fade-in slide-in-from-top-4 duration-500", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("h3", { className: "text-sm font-black text-white uppercase tracking-[0.2em] mb-6 flex items-center gap-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "w-6 h-6 rounded-lg bg-neutral-800 flex items-center justify-center text-[10px]", children: "2" }),
              "Configure Installation"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "bg-neutral-800/40 border border-neutral-800 rounded-3xl p-8 max-w-2xl", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] mb-3", children: "Target Version" }),
                  ...
                  selectedPlatform === "waterfall" && availableVersions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "mt-2 flex flex-wrap gap-2", children: availableVersions.slice(0, 5).map((v) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("button", { onClick: () => setSelectedVersion(v), className: "text-[9px] font-bold text-neutral-600 hover:text-white transition-colors", children: v }, v)) })
                ] }),
                ["forge", "fabric", "quilt", "waterfall"].includes(selectedPlatform) && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("label", { className: "block text-[10px] font-black text-neutral-500 uppercase tracking-[0.2em] mb-3", children: "Build / Loader" }),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                    "input",
                    {
                      type: "text",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "bg-rose-600/5 border border-rose-600/20 p-5 rounded-2xl mb-8", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-shield-exclamation text-rose-500 text-xl" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h5", { className: "text-[10px] font-black text-rose-500 uppercase tracking-[0.2em] mb-1", children: "Destructive Action" }),
                  /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-[10px] text-neutral-500 font-bold uppercase tracking-widest leading-relaxed", children: "This will stop your server and overwrite the primary executable. Current world files will be preserved." })
                ] })
              ] }) }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                "button",
                {
                  ...
                  children: installing ? /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-download" }),
                    "Install ",
  ...
  if (root) {
    root.render(
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BrowserRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ServerMinecraftInstallerPage, { pageData: data }) })
    );
