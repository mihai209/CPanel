(() => {
  ...
  function PermissionBadge({ permissions }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-primary-900/30 text-primary-400 border border-primary-500/30 px-3 py-1 rounded-full text-[11px] font-bold tracking-tight cursor-help shadow-sm hover:bg-primary-900/50 transition-colors flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { className: "bi bi-shield-check" }),
            permissions.length,
            " Permissions"
          ] }),
          isHovered && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "absolute z-50 left-0 mt-2 p-4 bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl w-72 animate-in fade-in zoom-in-95 duration-200 pointer-events-none", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "text-[10px] font-black text-neutral-500 uppercase tracking-widest mb-3 border-b border-neutral-800 pb-2 flex justify-between", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: "Permission Bundle" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "text-primary-500", children: [
                permissions.length,
                " items"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex flex-wrap gap-1.5 max-h-64 overflow-y-auto no-scrollbar", children: permissions.map((p) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-[10px] font-semibold bg-neutral-800 text-neutral-200 px-2 py-0.5 rounded border border-neutral-700", children: p }, p)) }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "mt-3 text-[10px] text-neutral-500 italic", children: "Move mouse away to close list" })
          ] })
        ]
      }
    );
  ...
  function ServerUsersPage({ pageData = data }) {
    ...
    const [editingMembership, setEditingMembership] = (0, import_react4.useState)(null);
    const [identifier, setIdentifier] = (0, import_react4.useState)("");
    const [selectedPermissions, setSelectedPermissions] = (0, import_react4.useState)(["server.view"]);
    const [selectedPreset, setSelectedPreset] = (0, import_react4.useState)("");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(ReactAppShell, { pageData, subtitle: "Users", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(PageContentBlock, { title: "Users", description: "Manage subusers and configure access control lists.", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-8", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-lg p-5 shadow-sm col-span-1 border-t-2 border-t-primary-500", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-xs font-bold text-neutral-500 uppercase tracking-widest mb-3", children: "Owner" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "font-bold text-white text-lg", children: owner ? owner.username : "Unknown" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-sm text-neutral-400 mt-1", children: owner ? owner.email : "-" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-lg overflow-hidden shadow-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-neutral-800/50 px-5 py-4 border-b border-neutral-700 flex justify-between items-center", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { className: "text-base font-bold text-neutral-100", children: "Subusers" }),
            canManageUsers && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { className: "bi bi-person-plus me-1" }),
                  " Invite"
                ]
              }
            )
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { className: "bg-neutral-800 border-b border-neutral-700", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "User" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Permissions" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Invited By" }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tbody", { children: !memberships.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { colSpan: "4", className: "text-center py-8 text-neutral-500 text-sm", children: "No subusers yet." }) }) : memberships.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { className: "border-b border-neutral-700/50 hover:bg-neutral-800/30 transition-colors", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("td", { className: "px-5 py-4", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "font-bold text-neutral-200 text-sm", children: entry.user ? entry.user.username : `#${entry.userId}` }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-xs text-neutral-500", children: entry.user?.email || "" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: "px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PermissionBadge, { permissions: entry.permissions }) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: "px-5 py-4 text-sm text-neutral-400", children: entry.invitedBy ? entry.invitedBy.username : "-" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { className: "px-5 py-4 text-right", children: canManageUsers ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
      ...
      isModalOpen && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/80 backdrop-blur-sm overflow-y-auto", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl w-full max-w-3xl my-8", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex justify-between items-center p-5 border-b border-neutral-700", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "text-lg font-bold text-white", children: editingMembership ? `Manage ${editingMembership.user?.username || "Subuser"}` : "Invite Subuser" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { onClick: () => setIsModalOpen(false), className: "text-neutral-400 hover:text-white transition", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { className: "bi bi-x-lg" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "p-5 overflow-y-auto max-h-[70vh]", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("form", { id: "subuserForm", method: "POST", action: `/server/${server.containerId}/users`, "data-turbo": "false", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("input", { type: "hidden", name: "membershipId", value: editingMembership ? editingMembership.id : "" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-2", children: "User Identifier" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mb-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-2", children: "Permissions" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg p-3 mb-4 flex flex-col md:flex-row gap-3 items-end", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex-1 w-full", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("label", { className: "block text-xs font-bold text-neutral-500 uppercase tracking-widest mb-1", children: "Preset Bundle" }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: "", children: "Custom Selection" }),
                      presets.map((p) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: p.id, children: p.label }, p.id))
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex gap-2 w-full md:w-auto", children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", onClick: applyPreset, className: "bg-primary-600/20 text-primary-400 border border-primary-600/30 hover:bg-primary-600/30 rounded px-4 py-2 text-sm font-bold transition flex-1 md:flex-none", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("i", { className: "bi bi-magic me-1" }),
                  " Apply Preset"
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: resetPermissions, className: "bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 rounded px-4 py-2 text-sm font-bold text-white transition flex-1 md:flex-none", children: "Reset" })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: catalog.map((perm) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "flex items-start gap-3 p-3 bg-neutral-800/50 border border-neutral-700 rounded-lg cursor-pointer hover:bg-neutral-800 transition-colors", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "input",
                {
                  type: "checkbox",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-sm font-bold text-white", children: perm }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-xs text-neutral-500 mt-0.5 whitespace-normal break-words", children: userPermissionDescriptions[perm] || "Access standard endpoints" })
              ] })
            ] }, perm)) })
          ] })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between p-5 border-t border-neutral-700 bg-neutral-900 rounded-b-xl", children: [
          editingMembership ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("form", { method: "POST", action: `/server/${server.containerId}/users/${editingMembership.id}/delete`, "data-turbo": "false", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "submit", className: "text-red-500 hover:text-red-400 text-sm font-bold transition", children: "Remove Subuser" }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", {}),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { onClick: () => setIsModalOpen(false), className: "px-4 py-2 bg-neutral-800 hover:bg-neutral-700 text-white rounded text-sm font-bold", children: "Cancel" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "button",
              {
  ...
  if (root) {
    root.render(/* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ServerUsersPage, { pageData: data }));
