(() => {
  ...
  function ServerSchedulesPage({ pageData = data }) {
    ...
    const [isTutorialOpen, setIsTutorialOpen] = (0, import_react6.useState)(false);
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(ReactAppShell, { pageData, subtitle: "Schedules", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(PageContentBlock, { title: "Schedules", description: "Automate server actions with cron-based tasks.", children: [
        pageData.success && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "bg-green-600/20 border-l-4 border-green-600 text-green-100 p-4 rounded-r-lg mb-6 shadow-sm", children: pageData.success }),
        pageData.error && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "bg-red-600/20 border-l-4 border-red-600 text-red-100 p-4 rounded-r-lg mb-6 shadow-sm", children: pageData.error }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "flex justify-end mb-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-question-circle me-1" }),
              " Tutorial"
            ]
          }
        ) }),
        canManageSchedules && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-lg p-5 mb-8 shadow-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "text-lg font-bold text-neutral-100 mb-4", children: "Create Schedule" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("form", { method: "POST", action: `/server/${server.containerId}/schedules`, className: "flex flex-col gap-4", "data-turbo": "false", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-4 items-end", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "md:col-span-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-1.5", children: "Name" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "text", name: "name", required: true, className: "w-full bg-neutral-800 border border-neutral-700 rounded px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-primary-500" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "md:col-span-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-1.5", children: "Action" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { name: "action", className: "w-full bg-neutral-800 border border-neutral-700 rounded px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-primary-500", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "command", children: "Command" }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "power", children: "Power" })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "md:col-span-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-1.5", children: "Cron" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "text", name: "cron", defaultValue: "* * * * *", className: "w-full bg-neutral-800 border border-neutral-700 rounded px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-primary-500 font-mono" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "md:col-span-3", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("label", { className: "block text-xs font-bold text-neutral-400 uppercase tracking-widest mb-1.5", children: "Payload" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "text", name: "payload", placeholder: "say hello / restart", className: "w-full bg-neutral-800 border border-neutral-700 rounded px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-primary-500 font-mono" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "md:col-span-2", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "submit", className: "w-full bg-primary-600 hover:bg-primary-500 text-white text-sm font-bold px-4 py-2 rounded transition-colors shadow-sm", children: "Save" }) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex flex-wrap gap-6 mt-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "flex items-center gap-2 cursor-pointer", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "checkbox", name: "enabled", value: "1", defaultChecked: true, className: "bg-neutral-900 border-neutral-600 text-primary-500 focus:ring-0 rounded" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-sm text-neutral-300 font-semibold", children: "Enabled" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "flex items-center gap-2 cursor-pointer", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("input", { type: "checkbox", name: "onlyWhenOnline", value: "1", className: "bg-neutral-900 border-neutral-600 text-primary-500 focus:ring-0 rounded" }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-sm text-neutral-300 font-semibold", children: "Run only when server is online" })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "text-xs text-neutral-500 mt-4 bg-neutral-800/50 p-3 rounded border border-neutral-700/50", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Note:" }),
            " Power payload accepts ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "text-primary-400 mx-1", children: "start|stop|restart|kill" }),
            ". Command payload accepts any raw console text command."
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-lg overflow-hidden shadow-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "bg-neutral-800/50 px-5 py-4 border-b border-neutral-700", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { className: "text-base font-bold text-neutral-100", children: "Configured Schedules" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tr", { className: "bg-neutral-800 border-b border-neutral-700", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Name" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Action" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Cron" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Payload" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Status" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest", children: "Last Run" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("th", { className: "px-5 py-3 text-xs font-bold text-neutral-400 uppercase tracking-widest text-right", children: "Actions" })
            ] }) }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tbody", { children: schedules.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { colSpan: "7", className: "text-center py-8 text-neutral-500 text-sm", children: "No schedules configured." }) }) : schedules.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("tr", { className: "border-b border-neutral-700/50 hover:bg-neutral-800/30 transition-colors", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4 text-sm font-bold text-white", children: entry.name }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "px-2 py-1 bg-primary-600/20 text-primary-400 border border-primary-600/30 rounded text-xs font-bold", children: entry.action }) }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "text-xs bg-neutral-900 border border-neutral-700 px-2 py-1 rounded text-neutral-300 font-mono", children: entry.cron || "-" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "text-xs bg-neutral-900 border border-neutral-700 px-2 py-1 rounded text-neutral-300 font-mono break-all max-w-[200px] inline-block", children: entry.payload || "-" }) }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: `px-2 py-1 rounded text-xs font-bold ${entry.enabled === false ? "bg-neutral-800 text-neutral-400" : "bg-green-600/20 text-green-400 border border-green-600/30"}`, children: entry.enabled === false ? "Disabled" : "Enabled" }),
                entry.onlyWhenOnline && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "px-2 py-1 rounded text-xs font-bold bg-yellow-500/20 text-yellow-500 border border-yellow-500/30", children: "Online Only" })
              ] }) }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4 text-xs text-neutral-400", children: entry.lastRunAt ? new Date(entry.lastRunAt).toLocaleString() : "Never" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("td", { className: "px-5 py-4 text-right", children: canManageSchedules ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-end gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("form", { method: "POST", action: `/server/${server.containerId}/schedules/${entry.id}/run`, "data-turbo": "false", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "submit", className: "text-green-500 hover:text-green-400 bg-neutral-900 border border-neutral-700 hover:bg-neutral-800 p-1.5 rounded transition", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-play-fill text-sm" }) }) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("form", { method: "POST", action: `/server/${server.containerId}/schedules/${entry.id}/delete`, "data-turbo": "false", onSubmit: (e) => {
                  if (!window.confirm("Delete this schedule?")) e.preventDefault();
                }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "submit", className: "text-red-500 hover:text-red-400 bg-neutral-900 border border-neutral-700 hover:bg-neutral-800 p-1.5 rounded transition", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-trash text-sm" }) }) })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-neutral-500", children: "-" }) })
            ] }, entry.id)) })
          ] }) })
        ] })
      ] }),
      isTutorialOpen && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/80 backdrop-blur-sm", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-900 border border-neutral-700 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex justify-between items-center p-5 border-b border-neutral-700", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h3", { className: "text-lg font-bold text-white", children: "Schedules Tutorial" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { onClick: () => setIsTutorialOpen(false), className: "text-neutral-400 hover:text-white transition", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("i", { className: "bi bi-x-lg" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "p-6 overflow-y-auto max-h-[70vh]", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("p", { className: "text-neutral-400 mb-6 leading-relaxed", children: [
            "Use schedules to execute commands automatically. Everything is processed according to the panel's timezone (",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded text-primary-400", children: timezone }),
            ")."
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h4", { className: "text-white font-bold mb-3 flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "bg-primary-600/20 text-primary-400 w-6 h-6 flex items-center justify-center rounded-full text-xs", children: "1" }),
            "Core Fields"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("ul", { className: "text-neutral-400 mb-6 space-y-2 ml-2 border-l-2 border-neutral-800 pl-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Name:" }),
              " Name of the task (e.g. ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded", children: "Auto Save" }),
              ")."
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Action:" }),
              " ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded", children: "command" }),
              " or ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded", children: "power" }),
              "."
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Cron:" }),
              " Format is ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded", children: "minute hour day month weekday" }),
              "."
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Payload:" }),
              " The console command for `command` tasks, or ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { className: "bg-neutral-800 px-1 rounded", children: "start|stop|restart|kill" }),
              " for power."
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h4", { className: "text-white font-bold mb-3 flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "bg-primary-600/20 text-primary-400 w-6 h-6 flex items-center justify-center rounded-full text-xs", children: "2" }),
            "Quick Examples"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg p-4 mb-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-sm font-bold text-white mb-2 pb-2 border-b border-neutral-700/50", children: "Autosave every 5 minutes" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("pre", { className: "text-sm text-primary-300 font-mono", children: "Name: Auto Save Action: command Cron: */5 * * * * Payload: save-all" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "bg-neutral-800 border border-neutral-700 rounded-lg p-4 mb-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-sm font-bold text-white mb-2 pb-2 border-b border-neutral-700/50", children: "Daily Restart at 04:00" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("pre", { className: "text-sm text-primary-300 font-mono", children: "Name: Daily Restart Action: power Cron: 0 4 * * * Payload: restart" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h4", { className: "text-white font-bold mb-3 flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "bg-primary-600/20 text-primary-400 w-6 h-6 flex items-center justify-center rounded-full text-xs", children: "3" }),
            "Recommendations"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("ul", { className: "text-neutral-400 mb-2 space-y-2 ml-2 border-l-2 border-neutral-800 pl-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              "Check ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("em", { children: "Run only when server is online" }),
              " for in-game commands that require the runtime to be active."
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("li", { children: [
              "For critical tasks, click ",
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "Run" }),
              " immediately after creation to test the payload directly."
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "p-4 border-t border-neutral-700 bg-neutral-800/50 flex justify-end", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { onClick: () => setIsTutorialOpen(false), className: "px-5 py-2 bg-neutral-700 hover:bg-neutral-600 text-white rounded text-sm font-bold transition", children: "Got It" }) })
      ] }) })
    ] });
  }
  var server_schedules_default = ServerSchedulesPage;
  if (root) {
    root.render(/* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ServerSchedulesPage, { pageData: data }));
