(() => {
  ...
  function ToneBadge({ tone, children }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: `px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider border ${colors[tone] || colors.neutral}`, children });
  }
  function ServerActivityPage({ pageData = data }) {
    ...
    const [isClearing, setIsClearing] = import_react8.default.useState(false);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ReactAppShell, { pageData, subtitle: "Activity", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(PageContentBlock, { title: "Server Activity", description: "Tracking all events and state changes for your server.", children: [
      canClear && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex justify-end mb-6", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: `bi ${isClearing ? "bi-hourglass-split" : "bi-trash3-fill"}` }),
            isClearing ? "Clearing History..." : "Clear Activity History"
          ]
        }
      ) }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden mb-8 shadow-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "bg-neutral-800/50 px-5 py-4 border-b border-neutral-800", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { className: "text-xs font-black text-neutral-400 uppercase tracking-[0.2em]", children: "What Changed" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("tr", { className: "text-[10px] font-bold text-neutral-500 uppercase tracking-widest border-b border-neutral-800", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "When" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Actor" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Category" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Summary" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Diff" })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tbody", { className: "text-sm", children: changeLogs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { colSpan: "5", className: "px-6 py-10 text-center text-neutral-500 italic", children: "No configuration changes recorded yet." }) }) : changeLogs.map((entry, idx) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("tr", { className: "border-b border-neutral-800/50 hover:bg-white/[0.02] transition-colors", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4 text-neutral-400 whitespace-nowrap", children: new Date(entry.createdAt).toLocaleString() }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "w-6 h-6 rounded-full bg-neutral-800 flex items-center justify-center text-[10px] font-bold text-primary-400", children: entry.actor?.username?.charAt(0).toUpperCase() || "S" }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-neutral-200", children: entry.actor?.username || "system" })
            ] }) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "bg-neutral-800 text-neutral-400 px-2 py-0.5 rounded text-[10px] font-mono border border-neutral-700", children: entry.category || "-" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("td", { className: "px-6 py-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "font-bold text-neutral-200", children: entry.summary || entry.changeKey || "-" }),
              entry.changeKey && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "text-[10px] text-neutral-500 font-mono mt-0.5", children: entry.changeKey })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4 max-w-xs", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-[10px] space-y-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-red-500/50 font-bold uppercase w-10", children: "Before:" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("code", { className: "text-neutral-500 truncate block", children: JSON.stringify(entry.beforeValue) })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-green-500/50 font-bold uppercase w-10", children: "After:" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("code", { className: "text-neutral-300 truncate block", children: JSON.stringify(entry.afterValue) })
              ] })
            ] }) })
          ] }, idx)) })
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden shadow-sm", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "bg-neutral-800/50 px-5 py-4 border-b border-neutral-800", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h3", { className: "text-xs font-black text-neutral-400 uppercase tracking-[0.2em]", children: "Activity Log" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "overflow-x-auto", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("table", { className: "w-full text-left border-collapse", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("tr", { className: "text-[10px] font-bold text-neutral-500 uppercase tracking-widest border-b border-neutral-800", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "When" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Actor" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4 text-center", children: "Action" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4", children: "Summary" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("th", { className: "px-6 py-4 text-right", children: "IP Address" })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tbody", { className: "text-sm", children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { colSpan: "5", className: "px-6 py-10 text-center text-neutral-500 italic", children: "No activity logs found." }) }) : logs.map((log, idx) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("tr", { className: "border-b border-neutral-800/50 hover:bg-white/[0.02] transition-colors", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4 text-neutral-400 whitespace-nowrap", children: new Date(log.createdAt).toLocaleString() }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "text-neutral-200 font-medium", children: log.actor?.username || "system" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ToneBadge, { tone: getActivityTone(log.action), children: (log.action || "").split(":").pop().replace(/\./g, " ") }) }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("td", { className: "px-6 py-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "text-neutral-300", children: getActivitySummary(log) }),
              log.metadata?.reason && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "text-[10px] text-neutral-500 italic mt-1 flex items-center gap-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("i", { className: "bi bi-info-circle" }),
                " ",
                log.metadata.reason
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("td", { className: "px-6 py-4 text-right text-neutral-500 font-mono text-xs", children: log.ip || "\u2013" })
          ] }, idx)) })
        ] }) })
      ] })
    ] }) });
  ...
  if (root) {
    root.render(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ServerActivityPage, { pageData: data }));
  }
})();
