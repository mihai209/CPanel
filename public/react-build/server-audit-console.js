(() => {
  ...
  function ServerAuditConsolePage({ pageData = {} }) {
    ...
    const [logs, setLogs] = (0, import_react7.useState)(initialLogs);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(ReactAppShell, { pageData, subtitle: "Audit Console", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "max-w-7xl mx-auto h-[calc(100vh-180px)] flex flex-col", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "bg-neutral-900 border border-neutral-800 rounded-2xl flex flex-col h-full overflow-hidden shadow-2xl", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-6 py-4 bg-neutral-900/50 border-b border-neutral-800 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("h2", { className: "text-sm font-black text-neutral-500 uppercase tracking-widest flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-shield-shaded text-primary-400" }),
          "Immutable Security Tape"
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "px-3 py-1 rounded-full bg-neutral-950 border border-neutral-800 text-[10px] font-black text-neutral-500 uppercase tracking-tighter", children: [
            logs.length,
            " Total Events"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "w-2 h-2 rounded-full bg-green-500 animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.5)]" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { ref: scrollRef, className: "flex-1 overflow-y-auto p-4 space-y-2 bg-[#0c0c0f] font-mono no-scrollbar", children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "h-full flex flex-col items-center justify-center text-center opacity-30 select-none", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-broadcast text-6xl mb-4" }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-sm uppercase tracking-[0.2em] font-black", children: "Waiting for audit heartbeat..." })
      ] }) : logs.slice(-500).map((log, i) => {
        const meta = log.metadata || {};
        return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "group flex gap-4 p-3 rounded-xl hover:bg-neutral-900/40 transition-all border border-transparent hover:border-neutral-800/50", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "w-16 shrink-0 text-[10px] font-black text-neutral-700 tabular-nums pt-1", children: [
            "#",
            log.id
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex-1 space-y-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-wrap items-center gap-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: `px-2 py-0.5 rounded border text-[9px] font-black uppercase tracking-widest ${getActionClass(log.action)}`, children: log.action.replace("server:", "") }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[10px] font-bold text-neutral-600", children: new Date(log.createdAt).toLocaleTimeString() }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-[10px] font-black text-primary-500 uppercase tracking-tighter", children: [
                "@",
                log.actor?.username || "system"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "text-xs leading-relaxed break-all", children: meta.command ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex gap-2 items-start", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-600 shrink-0", children: "$" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("code", { className: "text-blue-300 bg-blue-500/5 px-2 py-0.5 rounded-md border border-blue-500/10 select-all", children: meta.command })
            ] }) : meta.powerAction ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-600", children: "power_intent:" }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-yellow-500 font-black uppercase text-[10px]", children: meta.powerAction })
            ] }) : meta.message ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-neutral-400 italic", children: [
              '"',
              meta.message,
              '"'
            ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-neutral-700 italic", children: "No further details captured" }) })
          ] })
        ] }, log.id);
      }) }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "px-6 py-3 bg-neutral-950 border-t border-neutral-800 flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-[10px] font-black text-neutral-600 uppercase tracking-widest flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("i", { className: "bi bi-info-circle text-blue-500" }),
          "Audit entries are permanent and cannot be deleted by any user level."
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "text-[9px] font-mono text-neutral-700", children: [
          "SESSION_BUF: ",
          logs.length,
          " / 500"
        ] })
